...
const PLACES_PRESET = [
  {
    ...
    cat: "mercado",
    city: "Manaus",
    address: "Av. do Turismo, 5509 - Tarumã, Manaus - AM, 69041-010",
    image: "Vitória Supermercados.jpeg",
    noise: 3, light: 3, flow: 3,
    sensory: "medio"
  },
  {
    id: "manaus-plaza-shopping-centro-convencoes",
    name: "Manaus Plaza Shopping & Centro de Convenções",
    cat: "shopping",
    city: "Manaus",
    address: "Av. Djalma Batista, 2100 - Chapada, Manaus - AM, 69050-010",
    image: "Manaus Plaza Shopping & Centro de Convenções.jpeg",
    noise: 3, light: 4, flow: 3,
    sensory: "medio"
  },
  {
    id: "supermercado-veneza",
    name: "Supermercado Veneza",
    cat: "mercado",
    city: "Manaus",
    address: "Av. do Turismo, 116 - Tarumã, Manaus - AM, 69041-010",
    image: "Supermercado Veneza.jpeg",
    noise: 3, light: 3, flow: 3,
    sensory: "medio"
  },
  {
    id: "hiper-db-nova-cidade",
    name: "Hiper DB Nova Cidade",
    cat: "mercado",
    city: "Manaus",
    address: "Av. Margarita, 1359 - Cidade Nova, Manaus - AM, 69097-305",
    image: "Hiper DB Nova Cidade.jpeg",
    noise: 4, light: 4, flow: 4,
    sensory: "alto"
  },
  {
    ...
    cat: "shopping",
    city: "Manaus",
    address: "Av. Coronel Teixeira, 5705 - Ponta Negra, Manaus - AM, 69037-000",
    image: "Shopping Ponta Negra.jpeg",
    noise: 3, light: 4, flow: 3,
    sensory: "medio"
  },
  {
    id: "pizzaria-super-herois",
    name: "Pizzaria do Super Heróis",
    cat: "gastronomia",
    city: "Manaus",
    address: "Av. do Turismo, 1313 - Ponta Negra, Manaus - AM, 69037-005",
    image: "Pizzaria do Super Heróis.jpeg",
    noise: 3, light: 3, flow: 3,
    sensory: "medio"
  },
  {
    ...
    cat: "cultural",
    city: "Manaus",
    address: "Largo de São Sebastião - Centro, Manaus - AM, 69067-080",
    image: "Teatro amazonas.jpeg",
    noise: 3, light: 3, flow: 3,
    sensory: "medio"
  },
  {
    ...
    cat: "shopping",
    city: "Manaus",
    address: "Av. Mário Ypiranga, 1300 - Adrianópolis, Manaus - AM, 69053-165",
    image: "Manauara Shopping.jpeg",
    noise: 4, light: 4, flow: 4,
    sensory: "alto"
  },
  {
    id: "parque-cidade-da-crianca-castro-alves",
    name: "Parque Cidade Da Criança - Castro Alves",
    cat: "infantil",
    city: "Manaus",
    address: "R. Castro Alves, 100 - Aleixo, Manaus - AM, 69060-090",
    image: "Parque cidade da criança.jpeg",
    noise: 3, light: 2, flow: 3,
    sensory: "medio"
  },
  {
    id: "inpa",
    name: "INPA - National Institute of Amazonian Research",
    cat: "natureza",
    city: "Manaus",
    address: "Av. Bem-Te-Vi, s/n - Petrópolis, Manaus - AM, 69060-001",
    image: "INPA.jpeg",
    noise: 2, light: 2, flow: 2,
    sensory: "medio"
  },
  {
    id: "musa-museu-da-amazonia",
    name: "MUSA - Museu da Amazônia",
    cat: "natureza",
    city: "Manaus",
    address: "Av. Margarita, 6305 - Cidade de Deus, Manaus - AM, 69099-415",
    image: "MUSA.jpeg",
    noise: 2, light: 2, flow: 2,
    sensory: "baixo"
  },
  {
    id: "parque-municipal-do-mindu",
    name: "Parque Municipal do Mindu",
    cat: "parque",
    city: "Manaus",
    address: "Parque Dez, Manaus - AM (próximo ao igarapé do Mindu)",
    image: "parque municipal do Mindu.jpeg",
    noise: 2, light: 2, flow: 2,
    sensory: "baixo"
  },
  {
    ...
    cat: "infantil",
    city: "Manaus",
    address: "Av. Autaz Mirim, 6732 - São José 3, Manaus - AM, 69087-215",
    image: "Nenê Park.jpeg",
    noise: 4, light: 3, flow: 4,
    sensory: "alto"
  },
  {
    id: "mirage-park",
    ...
    cat: "infantil",
    city: "Manaus",
    address: "Av. Mário Ypiranga, 3951 - Parque 10 de Novembro, Manaus - AM, 69050-030",
    image: "Mirage park.jpeg",
    noise: 4, light: 4, flow: 4,
    sensory: "alto"
  },
  {
    ...
    cat: "infantil",
    city: "Manaus",
    address: "Av. Arquiteto J. H. Bento Rodrigues, 3760 - Shopping Manaus Via Norte, Manaus - AM, 69093-149",
    image: "Puppy play.jpeg",
    noise: 4, light: 4, flow: 4,
    sensory: "alto"
  },
  {
    id: "planeta-imaginario-manaus",
    name: "Planeta Imaginário Manaus",
    cat: "infantil",
    city: "Manaus",
    address: "Av. Coronel Teixeira, 5705 - Piso L3, Ponta Negra, Manaus - AM, 69037-000",
    image: "Planeta imaginário.jpeg",
    noise: 4, light: 4, flow: 4,
    sensory: "alto"
  },
  {
    ...
    cat: "infantil",
    city: "Manaus",
    address: "Praça Dom Pedro II - Centro Histórico, Manaus - AM",
    image: "Passinho kids.jpeg",
    noise: 3, light: 3, flow: 3,
    sensory: "medio"
  }
];
